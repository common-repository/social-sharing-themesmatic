		...
		if( class_exists( 'WP_Customize_Control' ) ):
		    ...
		    public function render_content() { ?>
				<div class="themesmatic-pro">
					...
					<a href="<?php echo esc_url('https://www.themesmatic.com'); ?>" target="_blank"><img src="<?php echo esc_url( plugins_url('img/themesmatic-themes-panel.jpg',  __FILE__ ) ); ?>" alt="themesmatic-wordpress-themes" /></a>
...
// creates css output
 if ( ! function_exists( 'themesmatic_sharing_css' ) ) {
	...
	wp_enqueue_style(
	    ...
	    plugins_url('/css/social-sharing.css', __FILE__ )
	);
