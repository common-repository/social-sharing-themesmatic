...
echo '</br>';
echo '<a class="themesmatic-plugin-support" href=' . esc_url('https://wordpress.org/support/plugin/social-sharing-themesmatic/') . '>';
...
echo '<a href=' . esc_url('https://www.themesmatic.com') . ' target="_blank"><img src=' . esc_url( plugins_url('img/themesmatic-themes-panel.jpg',  __FILE__ ) ) . ' alt="themesmatic-wordpress-themes" /></a>';
echo '</aside>';
